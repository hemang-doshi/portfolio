    ...
    <footer className="bg-aubergine py-16 text-plum-tinted relative z-10">
      <div className="section-shell flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <HemangLogo forceLight />
          <div>
            <p className="font-bold text-canvas text-sm tracking-[-0.01em]">{siteConfig.name}</p>
            <div className="mt-1 flex flex-wrap items-center gap-x-2.5 gap-y-1 text-[length:var(--text-body-sm)] text-plum-tinted/70 font-medium">
